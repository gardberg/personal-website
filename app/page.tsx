  ...
  return (
    <div className="max-w-3xl mx-auto">
      <section className="mb-20 text-center">
        <h1 className="text-4xl font-bold mb-10">Hi, I&apos;m Lukas!</h1>
        <p className="text-l mb-10 max-w-xl mx-auto">
        ...
        <div className="flex justify-center space-x-6">
          ...
          <a href="mailto:lukasgardberg@gmail.com" className="">
          ...
          <button className="cs-btn">
          <a href="https://www.linkedin.com/in/lukas-gardberg" className="">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          ...
          <button className="cs-btn">
          <a href="https://github.com/gardberg" className="">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
